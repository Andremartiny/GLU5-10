...
> [!note]- Løsning 
> Vi er ute etter å beskrive forholdet $\frac{b}{a}$. La oss kalle dette for $x$. Videre får vi vite at $\frac{b}{a}= \frac{a}{\frac{b}{2}}$. Nå kan vi regne videre at 
> $$
> \begin{align*}\frac{b}{a}& =\frac{a}{\frac{b}{2}} \\ x & = \frac{2a}{2\frac{b}{2}} \\ & = \frac{2a}{b} \\ & = \frac{2\frac{a}{a}}{\frac{b}{a}} \\ & = \frac{2}{x}.\end{align*}
> $$
...
>  **Vurderingskriterier**
>  
>  Besvarelsen må gjøre alle oppgavene for å få godkjent.
>  1. Besvarelsen må få fram at $LI = a+x-b$.
>  2. Besvarelsen må peke på at $A = (a+x)h$.
>  3. Besvarelsen må få fram at $B = \frac{(a+x-b)h}{2}$ og at $C = \frac{xh}{2}$.
>  4. Besvarelsen må få fram arealet. Det vil være naturlig å regne seg fram ved å se på $A-B-C$.
> $$
> \begin{aligned}
