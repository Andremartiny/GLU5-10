...
Eksemplet illustrerer *addisjonssetningen.* Med ord sier den: For å telle antallet
elementer i to mengder som har noen felles elementer, kan vi telle antallet
i hver av dem, og trekke fra antallet de har felles, ettersom disse
telles dobbelt.
...
> betegner $A \cup B$ ("A eller B") unionen og $A\cap B$ ("A og B") snittet av mengdene, mens $n(A)$ betyr *antall elementer i* $A$*.* Da
> har vi at
>
> $$
