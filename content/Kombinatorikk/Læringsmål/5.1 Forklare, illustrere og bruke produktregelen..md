...
> [!note]- Løsning 
>  **Vurderingskriterier**
>  Her må besvarelsen bruke at det er tre valg som må tas. I hver runde er det henholdsvis 2, 2 og 3 valgmuligheter, dermed $2\cdot 2\cdot 3 = 12$ mulige treningsøkter som kan lages.
...
> [!note]- Løsning 
> **Vurderingskriterier**
> 1. Her må besvarelsen bruke at det er tre valg som må tas. I hver runde er det henholdsvis 2, 2 og 3 valgmuligheter, dermed $2\cdot 2\cdot 3 = 12$ mulige treningsøkter som kan lages.
> 2. Besvarelsen må lage en illustrasjon (for eksempel et valgtre, rektangulært arrangement osv) av problemet og bruke denne til å vise hvorfor produktregelen må gjelde generelt. Se heftet.
