...
> **Vurderingskriterier**
> 
> Besvarelsen må bruke et eksempel med tilhørende illustrasjon til å forklare addisjonssetningen. Typisk vil dette være å lage et Venn-diagram og koble eksempelet opp til Venn-diagrammet og bruke dette til å forklare setningen.
...
> [!note]- Løsning 
> **Vurderingskriterier**
> 1. Problemet kan illustreres slik som under. Der ser vi at det er noe felles mellom KSI og de to treningssentrene. Legger vi sammen alle tre gruppene får vi $100+50+60 = 210$. Da kan vi merke oss at vi overteller de som er tilknyttet KSI og Spicheren to ganger *og* vi overteller de som er tilknyttet KSI og Sats to ganger. Totalt overteller vi $40 + 40 = 80$. Det må bety at det er $210-80 = 130$ som er tilknyttet minst en av de tre. Siden det skal være 300 studenter totalt, må det være 170 som ikke er tilknyttet noen av de. <br>![](https://raw.githubusercontent.com/Andremartiny/MA-173/d4c64e084e3d4cc1d8e73e242d9ca5b7fadbb7c8/img/sannsyn/sannsynv3add.drawio.svg)
> 2. Forklaringen må bruke illustrasjonen og få frem hvorfor addisjonssetningen er som den er. Spesielt viktig er det at illustrasjonen og forklaringen får fram hvorfor vi trekker fra snittet. Se [[Kombinatorikk/5.4.1 Addisjonssetningen|Addisjonssetningen]].
