...
> [!note]- Løsning 
>  **Vurderingskriterier**
>  1. $-4 + 8p -6p - 5 + 20p = 22p-9$.
>  2. 
>  $$
>  \frac{1}{z-4}\cdot \frac{4z-16}{4z} = \frac{4(z-4)}{(z-4)4z} = \frac{1}{z}
>  $$
...
>  **Vurderingskriterier**
>  
>  Første oppgave kan vi skrive slik
>  $$
>  \begin{aligned} 
>  \frac{x(x+1)}{2}
>  +\frac{3(x-1)x}{2}  &= \frac{x}{2}((x+1)+3(x-1)) \\  &= \frac{x}{2}(x+1+3x-3) \\  &= \frac{x}{2}(4x-2) \\ &= x(2x-1).\end{aligned} 
> $$
> 
> Andre oppgave kan løses slik
> $$
> \begin{aligned} 
> (h+1)h+\frac{3h+3}{2}+ \frac{h^2+h}{2} &= (h+1){\color{#e796f5} h }+{\color{#f46f22} 3 }\cdot\frac{h+1}{{\color{#f46f22} 2 }}+ {\color{#5ca6f4} \frac{h}{2} }(h+1) \\  &= (h+1)\left( {\color{#e796f5} h }+{\color{#f46f22} \frac{3}{2} }+ {\color{#5ca6f4} \frac{h}{2} } \right) \\ &= (h+1)\left( \frac{3h+3}{2} \right) \\ &= \frac{(h+1)(3(h+1))}{2} \\ &= \frac{3}{2}(h+1)^2.
> \end{aligned} 
> $$
> 
> 
...
> $$
> \frac{3y^2+12y+12}{3y+6} = \frac{\cancel{ 3 }(y+2)\cancel{ (y+2)}}{\cancel{ 3 }\cancel{ (y+2) }} = y+2.
> $$
...
>  $$
>  \begin{aligned} 
>  {\color{#e796f5} \frac{x(x+1)}{2}
>  +\frac{3(x-1)x}{2}  }+ {\color{#5ca6f4} \frac{(x+2)x}{3} + \frac{(x+2)(2x-2)}{6}  } &= {\color{#e796f5} \frac{x}{2}((x+1)+3(x-1)) } +{\color{#5ca6f4}  (x+2)\frac{2x+(2x-2)}{6} }  \\  &= \frac{x}{2}(x+1+3x-3) + (x+2)\frac{4x-2}{6}\\  &= \frac{x}{2}({\color{#3cc15c} 4x-2 })+\frac{(x+2){\color{#3cc15c} (2x-1) }}{3} \\ &= ({\color{#3cc15c} 2x-1 })\left( x+\frac{x+2}{3} \right) \\ &= (2x-1)\left( \frac{4x+2}{3}  \right) \\ &=(2x-1)(2x+1)\cdot\frac{2}{3} .\end{aligned} 
>  $$
>  
>  Andre oppgave kan løses slik
>  $$
>  \begin{aligned}{\color{#e796f5}  (h+1)h }+{\color{#f46f22} \frac{3h+3}{2} }+{\color{#5ca6f4} \frac{h^2+h}{2} } -{\color{#fbc544}  \frac{6h-6}{\frac{2}{h}} }+{\color{#b136c7} \frac{2h}{3}-\frac{2}{3} } &= {\color{#e796f5} (h+1)h }+{\color{#f46f22} 3\cdot\frac{ h+1}{2} }+{\color{#5ca6f4} h\cdot\frac{h+1}{2} } - {\color{#fbc544} 3h\cdot(h+1) }+{\color{#b136c7} \frac{2}{3}(h-1)  }\\ &= (h+1)\left({\color{#e796f5} h }+ {\color{#f46f22} \frac{3}{2} } +{\color{#5ca6f4} \frac{h}{2} }-{\color{#fbc544} 3h } \right) + {\color{#b136c7} \frac{2}{3}(h-1)  }\\ &= (h+1)\left( \frac{2h+3+h-6h}{2} \right) +\frac{2}{3}(h-1) \\ &= (h+1)\left( \frac{-3h+3}{2} \right)+\frac{2}{3}(h-1) \\ &= -\frac{3}{2}\cdot(h+1)(h-1)+\frac{2}3{}(h-1) \\ &= (h-1)\left( -\frac{3}{2}(h+1)+\frac{2}{3} \right) \\ &= (h-1)\left( \frac{-9h-5}{6} \right) 
>  \\ &= -(h-1)\frac{9h-5}{6}\end{aligned} 
>  $$
