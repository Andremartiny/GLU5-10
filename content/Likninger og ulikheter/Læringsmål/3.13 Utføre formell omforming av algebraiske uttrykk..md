...
> [!note]- Løsning 
> $$
> \begin{align*} \frac{1}{2x-2}\cdot \frac{4x-4}{3} & = \frac{1}{2(x-1)}\cdot \frac{4(x-1)}{3} \\ &=  \frac{1}{2(x-1)}\cdot \frac{4(x-1)}{3} \\ &= \frac{\cancelto{ 2 }{ 4 }\cancel{ (x-1) }}{\cancelto{ 1 }{ 2 }\cdot3\cancel{ (x-1) }}\\ &= \frac{2}{3}.  \end{align*}
> $$
