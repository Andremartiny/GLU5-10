...
>  
>  Under ser du eksempler for hva som kan være godkjente oppgaver.
>  1. La tallet vi velger være $x$. Følger vi prosessen beskrevet får vi $\frac{(x+5)\cdot 4}{2}\cdot 3-2x-15$. Forenkler vi uttrykket får vi $(x+5)\cdot 3 - 2x-2 = 3x+15-2x-15 = x$, tallet som du begynte med.
>  2. Vi skal ha et uttrykk som forenkler seg til noe konstant. Da kan vi lage følgende uttrykk $\frac{(x+5)\cdot 4}{2}\cdot 3-3x-2= 13$. Vi ser at *tenk på et tall*-oppgaven blir da, tenk på et tall. Legg til 5 og gang tallet du fikk med 4. Trekk fra 16 og del svaret ditt på 2. Multipliser tallet du nå har med 3. Trekk fra det tredobbelte av tallet du opprinnelig valgte og trekk fra 2.
<br>
