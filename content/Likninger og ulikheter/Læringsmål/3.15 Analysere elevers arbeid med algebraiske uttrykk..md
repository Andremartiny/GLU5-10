...
>  
>  Besvarelsen må peke på alt som elevsvarene gjør rett og galt. 
>  1. Under er feilene påpekt.
>  - Eleven forkorter feil i første omgang. Deretter tar eleven teller + teller og nevner + nevner som også er feil. 
>  - Eleven gjør alt rett
>  - Eleven tar teller + teller og nevner + nevner som blir feil.
>  2. Under er forklaringer for hver oppgave
>  - Eleven har nok valgt å trekke fra først og tatt $3\cdot 5 : 1$. Dette gir feil svar.
>  - Eleven har valgt å ta 21-7 først og deretter dele for så å legge til 5. Det gir feil svar. 
>  - Eleven har valgt å trekke fra først, så multiplisert $3\cdot 3$ og lagt til 2. Det gir feil svar.
>  - Eleven har fått rett svar, følger vi tanken over kan eleven ha valgt å trekke fra først, men det får ingen betydning her. Alle forklaringer som eleven kan ha tenkt som gir rett svar godkjennes.
