...
>  $$
>  \begin{align*} 
>  5(x+3) & < 4+1 \\ 5x+15 & < 5 \\ 5x & < -10 \\ x & < -\frac{10}{5} = 2.
>  \end{align*} 
>  $$
...
> 
> $$
> \begin{aligned} 6(x+3) & < 3 \\ 6x+18 & < 3 \\ 6x & < -15 \\ x  & < -\frac{15}{6} = - \frac{5}{2}  \end{aligned}
$$
<br>
...
> [!note]- Løsning 
>  **Vurderingskriterier**
>  1. Må regne seg til $x \leq \frac{7}{2}$.
>  $$
> \begin{align*} \frac{-x+7}{7} & \leq \frac{5-x}{3}  && \quad \bigg|\cdot3\cdot7 \\ -3x+21 & \leq 35-7x \\ 4x & \leq 14 \\ x \leq \frac{14}{4}= \frac{7}{2}.\end{align*}  
> $$
>  1. Må sette opp en situasjon. Dette innebærer også å definere variabler (som er meningsfulle). Deretter må ulikheten løses og komme frem til at Andre kan kjøpe opp til 7 kortstokker.
...
> [!note]- Løsning 
>  **Vurderingskriterier**
>  1. Besvarelsen må konkludere med at 
> $$
> \begin{aligned} \displaystyle \frac{{-x+1}}{2} & \leq \frac{{12}}{7}  \\  (-x+1)  & \leq \frac{24}{7} \\ -x & \leq \frac{24}{7}-1 \\ x  & \geq -\frac{16}{7}.\end{aligned}
> $$
>  2. Besvarelsen må sette opp en ulikhet som samsvarer, typ $300< 20 + 60x$, der $x$ er antall timer Henrik står parkert. Deretter må ulikheten løses for å vise at $x > 5$.
