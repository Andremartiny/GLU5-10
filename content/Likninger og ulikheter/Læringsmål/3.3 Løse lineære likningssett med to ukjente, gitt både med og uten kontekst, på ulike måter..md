...
>  2. Vi vet at hvis $x$ er antall mynter som er verdt $3$ ren og $y$ er antall mynter verdt $5$ ren, så er $x+7 = 17$ og $3x+5y = 69$. <br> Løser vi med addisjonsmetoden kan det se slik ut. $$\begin{aligned} 3x+5y &= 69 \\ 3(x+y)-3(x+y)+2y & = 69-3\cdot 17 & \text{Bruker at } x+y = 17  \\ 2y  & = 18 \\ y &= 9.  \end{aligned}$$ Vi kan nå se at $x = 8$. <br> Løser vi med innsetting kan vi skrive $x = 17-y$ og sette inn og få $$\begin{aligned} 3(17-y) + 5y & = 69 \\ 3\cdot 17 + 2y & = 69,  \end{aligned}$$ og vi ser at vi får samme likning som over. Siste naturlige metode er grafisk løsning.
