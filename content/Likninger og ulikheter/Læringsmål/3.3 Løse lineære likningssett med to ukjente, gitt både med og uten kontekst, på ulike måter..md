...
>  **Vurderingskriterier**
>  
>  Begge oppgavene skal gjøres med metodene som er oppgitt. For eksempel kan besvarelsen begynne med å rydde litt i likningene. Første likning kan skrives om til
>  $$
>  6x+7y = 45,
>  $$
>  og andre likning kan skrives om til
...
>  3x+2y = 15.
>  $$
>  Hvis vi multipliserer andre likning med $-2$, da får vi det ekvivalente likningssettet
>  $$
>  \begin{align*} 
>  6x+7y & = 45, \\
>  -6x - 4y & = -30.
>  \end{align*} 
>  $$
>  Legger vi disse likningene sammen (addisjonsmetoden) ser vi at $3y = 15$, eller at $y = 5$ . Nå kan vi sette inn $y = 5$ i en av likningene å få at $x = \frac{10}{6}$.
>  
>  Innsetting kan vi løse ved å for eksempel ta andre likning $3x = -2y +15$ og dele på to. Det gir $x = -\frac{2}{3}y + \frac{15}{2}$. Setter vi nå dette inn i likning en får vi en likning med en ukjent som kan løses.
>  
...
>  6x+4y = 30.
>  $$
>  Hvis vi multipliserer andre likning med $-1$, da får vi det ekvivalente likningssettet
>  $$
>  6x+7y = 45,
>  $$
>  $$
>  -6x - 4y = -30.
>  $$
>  Legger vi disse likningene sammen (addisjonsmetoden) ser vi at $3y = 15$, eller at $y = 5$ . Nå kan vi sette inn $y = 5$ i en av likningene å få at $x = 1$.
>  
>  Innsetting kan vi løse ved å for eksempel ta andre likning, løse for $6x$ og sette rett inn i første likning. Det gir $30-4y+7y = 45$, som gir samme løsning som over.
>  
...
> > [!warning] Merk 
> > 
> > På oppgave b. bør vi være taktiske og ikke bruke mye tid. Siden vi har frihet, bør vi sette en av koeffisientene til 0. For eksempel gjøre $3x$ i første likning til $0x$. Da får vi $y=-5$ og det er rett frem og løse resten! 
> 
...
> [!note]- Løsning 
>  **Vurderingskriterier**
>  Begge oppgavene må gjøres, og besvarelsene må være mulig å følge.
>  1. Kan bruke logikk. For eksempel: Fordeler 17 3-ere, som gir 51 ren. Det er 18 for lite. 18:2=9, så må ha ni 5-ere og resten, det vil si åtte 3-ere.  
>  2. Vi vet at hvis $x$ er antall mynter som er verdt $3$ ren og $y$ er antall mynter verdt $5$ ren, så er $x+7 = 17$ og $3x+5y = 69$. <br> Løser vi med addisjonsmetoden kan det se slik ut. 
> $$
> \begin{aligned} 3x+5y &= 69 \\ 3(x+y)-3(x+y)+2y & = 69-3\cdot 17 & \text{Bruker at } x+y = 17  \\ 2y  & = 18 \\ y &= 9.  \end{aligned}
> $$ 
> Vi kan nå se at $x = 8$. <br> Løser vi med innsetting kan vi skrive $x = 17-y$ og sette inn og få $$\begin{aligned} 3(17-y) + 5y & = 69 \\ 3\cdot 17 + 2y & = 69,  \end{aligned}$$ og vi ser at vi får samme likning som over. Siste naturlige metode er grafisk løsning.
