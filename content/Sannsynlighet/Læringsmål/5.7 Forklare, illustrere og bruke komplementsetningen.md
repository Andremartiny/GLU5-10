...
> **Vurderingskriterier**
> 
> Vi beregner komplementet og ser at det er $3$ utfall per terning som ikke er primtall. Dermed er sannsynligheten $\frac{3\cdot3}{36} = \frac{9}{36}$ for at vi slår to terninger som ikke er primtall. Komplementsetninger gir oss nå $1-\frac{9}{36}= \frac{25}{35}$ i sannsynlighet for å slå minst en terning som viser et primtall. 
