...
> **Vurderingskriterier**
> 
> En måte å løse problemet på er følgende. Vi skriver fire tilfeldig påfølgende naturlige tall som, $n, n+1, n+2$ og $n+3$. Det er nå klart at nøyaktig ett av disse tallene må være i fire-gangen, altså inneholde faktoren 4. 
> 
> Vi har da mulighetene 
> 1. $n$ er i firegangen, altså $n = 4k$, som gir at $n+2 = 4k+2=2(2k+1)$, altså er dette tallet i 2-gangen. Totalt får vi faktorene 4 og 2 i produktet, altså noe i åttegangen.
> 2. $n+1$ er i firegangen, altså $n+1 = 4k$, som gir at $n+3 = 4k+2=2(2k+1)$ og samme konklusjon følger
> 3. $n+2$ er i firegangen, altså $n+2 = 4k$, som gir at $n = 4k-2=2(k-1)$, som er i togangen, og samme konklusjon følger.
> 4. $n+3 = 4k$ som gir $n+1 = 4k-2 = 2(k-1)$.
