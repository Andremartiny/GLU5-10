...
> \end{align}
> $$
> Da får vi 26 tolv ganger. Siden dette er summen lagt sammen to ganger må summen være $156$.<br>
...
> 2. Skriv summen $1+6+11+15+\ldots + 5n-4$ forlengs og baklengs under hverandre. Deretter må besvarelsen typisk gjøre noe slikt 
> $$ \begin{align}
> \phantom{+} & \phantom{((n+3}1 + \phantom{()n-3}6 +\phantom{()n-3}11 +\ldots+ 5n-9 + 5n-4 \\ + & (5n-4)+(5n-9)+ (5n-14)+  \ldots + \phantom{4n}\mathrel{\phantom{-}} 6 +\phantom{4n}\mathrel{\phantom{-}} 1\\ =& \underset{n\text{ ledd}}{\underbrace{(5n-3)+(5n-3)+(5n-3)\phantom{[]}+\ldots+(5n-3)+(5n-3)}}\\=& (5n-3)\cdot n.\end{align}
> $$
> Vi finner nå den eksplisitte formelen ved å dele på to. Det gir $F_n = \dfrac{(5n-3)n}{2}$.
