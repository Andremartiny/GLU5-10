...
>  **Vurderingskriterier**
>  
>  Besvarelsen *må* bruke stirre-hardt-metoden. For eksempel kan dette gjøres slik. Bryt ned figuren slik som i figuren under
>  ![600](https://raw.githubusercontent.com/Andremartiny/MA-173/1771a18e040735ec0055318ae74c13530a161541/img/tallteo/b%C3%A5ttall2.drawio.svg) 
>  
>  Vi ser at vi har to trekanter (blå og lilla) som er én større enn figurtallsnummeret, samt en trekant (rød) der størrelsen samsvarer med figurtallsnummeret. I tillegg har vi en rad som alltid er én større enn figurtallsnummeret (grønn). Setter vi det sammen får vi $2T\_{n+1}+T_n + n+1 =(n+1)(n+2)+\frac{n(n+1)}{2}+n+1$. Litt algebra gir oss 
>  
>  $$
>  \begin{aligned} (n+1)(n+2)+\frac{n(n+1)}{2}+n+1 & = (n+1)(n+2+ \frac{n}{2}+ 1 ) \\ & = (n+1)( \frac{2n+4+n+2}{2}) \\ &= \frac{(n+1)(3n+6)}{2} \end{aligned}
>  $$  
