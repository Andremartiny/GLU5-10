...
> [!note]- Løsning 
> Regninga ser slik ut: $$\begin{aligned} R_n - R_{n-1} & = n(n+1) -(n-1)(n-1+1) \\ &= n^2+n + (n-1)n \\ & = n^2 + n -(n^2-n )= 2n.\end{aligned}$$ <br> Som betyr at $R_n = R_{n-1}+2n$ der $R_1 = 2$.
...
> [!note]- Løsning 
> $$
> \begin{aligned}  H_n - H_{n-1} & = n(2n-1)-((n-1)(2(n-1)-1)) \\ & = 2n^2 -n-((n-1)(2n-2-1)) \\ &= 2n^2-n-((n-1)(2n-3)) \\ &= 2n^2-n-(2n^2-3n-2n+3) \\ &= 2n^2 - n -2n^3+5n-3 \\ &=4n-3 \end{aligned} 
> $$
...
> [!note]- Løsning 
> $$
> \begin{aligned}  F_n-F_{n-1} &= \frac{{3n^2-n}}{2}- \frac{{3(n-1)^2-(n-1)}}{2} \\ &= \frac{{3n^2-n-(3(n^2-2n+1)-n+1)}}{2} \\& = \frac{{3n^2-n-(3n^2-6n+3-n+1)}}{2} \\ &= {3n^2-n-3n^2+6n-3+n-1} \\ &= \frac{{6n-4}}{2}= 3n-2\end{aligned} 
> $$
...
> [!note]- Løsning 
> $$
> \begin{aligned}  S_n-S_{n-1} & = \frac{{5n^2-3n}}{2} - \frac{{5(n-1)^2-3(n-1)}}{2} \\ &= \frac{1}{2}\bigg(5n^2-3n-(5(n^2-2n+1)-3n+3)\bigg) \\ &= \frac{1}{2}\bigg(5n^2-3n-(5n^2-10n+5-3n+3)\bigg) \\ &= \frac{1}{2}\bigg(5n^2-3n-5n^2+10n-5+3n-3)\bigg) \\ &= \frac{1}{2}\bigg(10n-8)\bigg) = 5n-4\end{aligned} 
> $$
